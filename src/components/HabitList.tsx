...
export function HabitList() {
    ...
    const completionRate = getDailyCompletionRate(todayStr);
    ...
    return (
        <div className="flex flex-col gap-6">
            {/* Group: Today */}
            <div className="bg-[#191919] border border-[#2d2d2d] rounded-lg p-4 pb-4">
                <div className="flex items-center justify-between mb-4 px-2">
                    <h2 className="text-[#ededed] font-medium text-base">Today&apos;s Habits</h2>
                </div>
                        ...
                        >
                            {habits.map((habit) => (
                                <SortableHabitItem
                                    ...
                                    habit={habit}
                                    todayStr={todayStr}
                                    isCompleted={records[todayStr]?.includes(habit.id) || false}
                                    editingId={editingId}
                                    editName={editName}
                ...
                {/* Daily Progress Bar included within Today's box like Notion */}
